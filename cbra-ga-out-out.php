...
function cb_shortcode_opt_out($atts) {
    return '<a href="javascript:gaOptout();" onclick="alert("Google Analytics wurde deaktiviert");">Erfassung von Daten durch Google Analytics für diese Website deaktivieren</a>';
};
